  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Only clear comment, keep name/email if logged in or as is
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <div className="bg-[#0A0A0A] border border-white/10 rounded-2xl p-8 max-w-md w-full shadow-2xl animate-in fade-in zoom-in-95">
            ...
            <div className="space-y-4">
              ...
              {deleteEmail && deleteEmail.includes('@') && (
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-yellow-500/80 italic">
                    Note: Requests for non-logged in users/admins are sent to administrators for approval.
                  </p>
                </div>
              )}
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <Button
                  ...
                  className="h-11 px-6 font-bold rounded-xl bg-white/10 hover:bg-white/20"
                >
                  {isDeleting ? "Processing..." : "Delete Comment"}
                </Button>
              </div>
            </div>
          </div>
